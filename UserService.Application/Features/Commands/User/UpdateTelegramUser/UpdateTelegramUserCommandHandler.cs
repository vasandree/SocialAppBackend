...
public class UpdateTelegramUserCommandHandler : IRequestHandler<UpdateTelegramUserCommand, Domain.Entities.User>
{
    ...
    public async Task<Domain.Entities.User> Handle(UpdateTelegramUserCommand request, CancellationToken cancellationToken)
    {
