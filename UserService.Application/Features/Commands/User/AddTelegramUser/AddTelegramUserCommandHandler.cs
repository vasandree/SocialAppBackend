...
public class AddTelegramUserCommandHandler : IRequestHandler<AddTelegramUserCommand, Domain.Entities.User>
{
    ...
    public async Task<Domain.Entities.User> Handle(AddTelegramUserCommand request, CancellationToken cancellationToken)
    {
