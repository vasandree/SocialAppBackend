...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkspaceModule.Domain.Entities.Relation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkspaceModule.Domain.Entities.WorkspacePerson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkspaceModule.Domain.Entities.WorkspaceUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkspaceModule.Domain.Entities.Relation", b =>
                {
                    b.HasOne("WorkspaceModule.Domain.Entities.WorkspaceUnit", "FirstUnit")
                        .WithMany()
                        .HasForeignKey("FirstUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorkspaceModule.Domain.Entities.WorkspaceUnit", "SecondUnit")
                        .WithMany()
                        .HasForeignKey("SecondUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorkspaceModule.Domain.Entities.WorkspaceEntity", "WorkspaceEntity")
                        .WithMany("Relations")
